...
function Home(){
    return(
      <div>
        <Home1>
            <div>
                <Home1P1>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</Home1P1>
        ...
        <Home2>
            <Home2Left />
            <Home2Right>
                <Home2P1>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</Home2P1>
                <Home2P2>Mattis ipsum purus ante in ac.</Home2P2>
                <Home2P3>Orci amet lectus adipiscing venenatis, tempor non nisl mi condimentum. 
                    Non, magna eget velit, justo, iaculis. Quam morbi massa ipsum amet interdum</Home2P3>
            </Home2Right>
        </Home2>
        <Home3>
            <Home3P1>Recommended explanation according to the purpose of use</Home3P1>
            <Home3ImgWrap>
                <Home3Img>img 파일</Home3Img>
            </Home3ImgWrap>
            <Home3P2>Lorem ipsum dolor sit amet</Home3P2>
            <Home3P3>Orci amet lectus adipiscing venenatis, tempor non nisl mi condimentum. 
                Non, magna eget velit, justo, iaculis. Quam morbi massa ipsum amet interdum</Home3P3>
            <Home3Bottom>
                <Home3Bottom1 />
                <Home3Bottom2 />
                <Home3Bottom3 />
        ...
        <Home4>
            ...
            <Home4P3>Orci amet lectus adipiscing venenatis, tempor non nisl mi condimentum. Non, magna eget velit, justo, iaculis. Quam morbi massa ipsum amet interdum</Home4P3>

            <Home4P4>Lorem ipsum dolor sit amet</Home4P4>
            <Home4P5>Orci amet lectus adipiscing venenatis, tempor non nisl mi condimentum. Non, magna eget velit, justo, iaculis. Quam morbi massa ipsum amet interdum</Home4P5>
            <Home4P6>Orci amet lectus adipiscing venenatis, tempor non nisl mi condimentum. Non, magna eget velit, justo, iaculis. Quam morbi massa ipsum amet interdum</Home4P6>
            <Home4Div2></Home4Div2>
